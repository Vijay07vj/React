    ...
    return (
        <div className="header">
            <div className="Logo-container">
                <img className="Logo" src="https://d1csarkz8obe9u.cloudfront.net/posterpreviews/food-point-logo-%7C-food-boy-%7C-food-logo-design-template-e2faf8f1f6c3da2a217b8c043d9c544e_screen.jpg?ts=1687265859">
                </img></div>
...
const RestaurantCard =(props) =>{
    ...
    return(
        <div className="res-card">
            <img className="res-image" src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/" + resData.info.cloudinaryImageId} />
            <h3>{resData.info.name}</h3>
            <h4>{resData.info.cuisines.join(", ")}</h4>
            <h4>{resData.info.avgRating}⭐</h4>
            <h4>{resData.info.costForTwo}</h4>
            <h4>ETD: {resData.info.sla.deliveryTime} Minutes</h4>
        </div>
    )
}
const resList =[
    ...
    },
    {
      "info": {
        ...
        "availability": {
          "nextCloseTime": "2024-01-04 06:00:00",
          "opened": true
        },
        "badges": {
    ...
    },
    {
      "info": {
        ...
        "availability": {
          "nextCloseTime": "2024-01-04 03:15:00",
          "opened": true
        },
        "badges": {
          "textExtendedBadges": [
    ...
    },
    {
      "info": {
        ...
        "cloudinaryImageId": "wgfjrjepdtu5wvcoqnto",
        "locality": "1st Phase",
        "areaName": "JP Nagar",
        "costForTwo": "₹350 for two",
        "cuisines": [
      ...
      "cta": {
        "link": "https://www.swiggy.com/restaurants/rnr-biryani-taste-of-1953-1st-phase-jp-nagar-bangalore-330839",
        "type": "WEBLINK"
      }
    },
    {
